...
const Nursery = () => {
  return (
    <div style={{backgroundColor:'#06D001'}}>
          <Card >
    <Image src='/images/Academics.jpg' fluid
    loading='lazy'
...
<Col md={4} className='mx-2'>
  <Card className='h-100' style={{  animation:'bounce 1s ease-in-out infinite',borderRadius:'16px',boxShadow:'0,4px 8px rgba(0 ,0,0,0.1)', border:'1px', width:'100%', maxWidth:'400px', margin:'auto' }}>
    <Card.Body>
  
      <Card.Title >< i  class="bi bi-person-square h2"></i><h1>Primary School</h1></Card.Title>
...
<Col md={4} className='mx-2'>
<Card className='h-100' style={{transition:"all 0.3s ease-in-out ", borderRadius:'16px',boxShadow:'4px 8px rgba(0,0,0,0.1)', border:'1px', width6:'100%', maxWidth:'400px', margin:'auto' ,'&:hover':{boxShadow:'0 8px 16px rgba(0,0,0.2)', transform:'scale(1.05)'},transform:'scale(1.05)',}}>
<Card.Body href='# ' className='responsive-text' style={{backgroundColor:''}}>
...
<Col md={4} className='mx-2'>
  <Card  style={{borderRadius:'16px',boxShadow:'4px 8px rgba(0,0,0,0.1)', border:'1px', width:'100%', maxWidth:'400px', margin:'auto' ,'&:hover':{boxShadow:'0 8px 16px rgba(0,0,0.2)', transform:'scale(1.05)'},transform:'scale(1.05)',}}>
<Card.Body href='# ' className='responsive-text' >
...
<Card.Title >< i  class="bi bi-puzzle-fill h2"></i><h1>Our Programs</h1></Card.Title>
...
<Col md={4} className='mx-2'>
<Card className='h-90' style={{transition:"all 0.3s ease-in-out ", borderRadius:'16px',boxShadow:'4px 8px rgba(0,0,0,0.1)', border:'1px', width:'100%', maxWidth:'400px', margin:'auto' ,'&:hover':{boxShadow:'0 8px 16px rgba(0,0,0.2)', transform:'scale(1.05)'},transform:'scale(1.05)',}}>
<Card.Body href='# ' className='responsive-text' style={{backgroundColor:''}}>
